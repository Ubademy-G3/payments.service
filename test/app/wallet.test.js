  ...
  describe("/wallet", () => {
    ...
    describe("GET", () => {
      ...
      describe("when unexpected error happens", () => {
        beforeEach(async () => {
          spyWalletRepository.getAllWallets = jest.spyOn(walletRepository, "getAllWallets").mockImplementation(() => {
            throw new Error();
          });
      ...
      describe("when unexpected error happens gettin wallet by id", () => {
        it("should respond with unexpected error status", async () => {
          spyWalletRepository.getWalletById = jest.spyOn(walletRepository, "getWalletById").mockImplementation(() => {
            throw new Error();
          });
      ...
      describe("when invalid id getting wallet by id", () => {
        it("should respond with wallet not found status and body", async () => {
          spyWalletRepository.getWalletById = jest.spyOn(walletRepository, "getWalletById").mockReturnValueOnce(null);
